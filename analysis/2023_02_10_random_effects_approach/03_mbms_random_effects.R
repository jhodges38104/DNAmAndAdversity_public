...
for (exposure in c(early_life_exposures_mbms, adult_life_exposures_mbms)) {
  ...
  pooled_model <- pool(model) # this is pooling across the 40 imputations, not across the clocks
  ...
  pooled_model_1st_gen_age_estimators <- pool(model_1st_gen_age_estimators) # this is pooling across the 40 imputations, not across the clocks
  ...
  pooled_model_1st_gen <- pool(model_1st_gen) # this is pooling across the 40 imputations, not across the clocks
  ...
  pooled_model_2nd_gen <- pool(model_2nd_gen) # this is pooling across the 40 imputations, not across the clocks
