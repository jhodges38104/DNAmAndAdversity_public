...
ggsave(
  filename = here('figures/', 'mbms_early_life_analysis_ii_with_svs.png'),
  width = 18, height = 8,
  scale = .7
)
...
ggsave(
  filename = here('figures/', 'mesa_early_life_analysis_ii_with_svs.png'),
  width = 18, height = 10,
  scale = .7
)
...
ggsave(
  filename = here('figures/', 'mbms_adult_life_analysis_ii_with_svs_set1.png'),
  width = 18, height = 8,
  scale = .85
)
...
ggsave(
  filename = here('figures/', 'mbms_adult_life_analysis_ii_with_svs_set2.png'),
  width = 18, height = 8,
  scale = .85
)
...
ggsave(
  filename = here('figures/', 'mesa_adult_life_analysis_ii_with_svs_set1.png'),
  width = 18, height = 8,
  scale = .85
)
...
ggsave(
  filename = here('figures/', 'mesa_adult_life_analysis_ii_with_svs_set2.png'),
  width = 18, height = 8,
  scale = .85
)
...
analysis_ii_with_svs %>% 
  ...
  write.csv(here("figures/1st_and_2nd_pooled_estimates.csv"), row.names=FALSE)
