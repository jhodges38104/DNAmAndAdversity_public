...
mbms_qc_quality <- readr::read_csv(
  system.file(
    "mbms/epi_qc/mbms_qc_quality.csv",
    package = 'DNAm'
  )
)
...
exposure_variables_named_chr <- c(
  'Born in a Jim Crow State' = "jim_crowTRUE", 
  ...
  "Parent's Highest Education: < High School [ref: Parents with 4-year College Degree]" = "parents_educparents_no_hs",
  "Parent's Highest Education: >= High School, < 4 Year College Degree [ref: Parents with 4-year College Degree]" = "parents_educparents_hs_no_college",
  "Participant's Highest Education: < High School [ref: 4-year College Degree]" = "educno_hs_degree",
  "Participant's Highest Education: >= High School, < 4 Year College Degree [ref: 4-year College Degree]" = "educhs_no_college",
  "Experiences of Discrimination" = "eod_racial_small_scale",
  "Experiences of Discrimination (0) [ref: 1-2]" = "eod_racial_3_levels0",
  "Experiences of Discrimination (3+) [ref: 1-2]" = "eod_racial_3_levels3+",
  "Major Discrimination Scale (0) [ref: 1-2]" = "mds_racial_3_levels0",
  "Major Discrimination Scale (3+) [ref: 1-2]" = "mds_racial_3_levels3+",
  "-log10(household income / poverty line) in 2010 Dollars" = "neg_log_poverty_ratio",
  "Occupational Class — Non-Supervisory Employee [ref: Supervisory Employee, Owner]" = "occupationnonsupervisory_employee", 
  "Occupational Class — Unemployed [ref: Employed]" = "occupationunemployed", 
  "Housing Tenure — Paying Mortgage [ref: Own Home Free and Clear]" = "housingpaying_mortgage", 
  "Housing Tenure — Paying Rent [ref: Own Home Free and Clear]" = "housingrenter", 
  ...
  "Nitrous Oxides (Higher = More Pollution)" = "nitrous_oxides",
