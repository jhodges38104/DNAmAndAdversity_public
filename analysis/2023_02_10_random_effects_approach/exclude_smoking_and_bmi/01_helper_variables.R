...
exposure_variables_named_chr <- c(
  ...
  "Parent's Highest Education: < 4-year College Degree [ref: Parents with 4-year College Degree]" = "parents_educparents_lt_4yr_college_degree",
  "Participant's Highest Education: < 4-year College Degree [ref: 4-year College Degree]" = "educlt_4yr_college_degree",
