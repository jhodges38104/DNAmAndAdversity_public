...
#saveRDS(analysis_ii_with_svs, here(analysis_dir, "figures/underlying_data.rds")) # CT version
#saveRDS(analysis_ii_with_svs, here(analysis_dir, "figures/JAMA revisions/underlying_data_2023-08-30.rds")) # NJ version
# 
